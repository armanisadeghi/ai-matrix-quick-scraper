...
class ContentExtractor:
    ...
    def save_to_json(self):
        ...
        updated_data = {**existing_data, **self.page_dict, "unassociated": unassociated}
    ...
    def add_page_content(self, content, content_type="text"):
        ...
        if content_type == "text":
            ...
            if filtered_list:
                self.page_dict[self.current_header].append({"list_items": filtered_list})
    ...
    def filter_content(self, element):
        ...
        name_exclusion = [
                             'script', 'style', 'svg', 'head', 'nav', 'footer', 'select', 'button', 'figure', 'fieldset', 'form', 'section', 'mbox-text-span'
    ...
    def extract_tables(self, element):
        ...
        self.page_dict[self.current_header].append({"tables": data})
    ...
    def extract_ul_list(self, ul_element):
        ...
        if self.current_header not in self.page_dict:
            self.page_dict[self.current_header] = []
        self.page_dict[self.current_header].append({"list": data["list"]})
...
def use_local_html_file():
    ...
    extractor.scrape_local_html_file(r"D:\a_starter\ama\private-report.html",
